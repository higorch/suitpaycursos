<div class="relative">
    ...
    <div wire:loading.class="loading-box-card" class="bg-white border border-[#E5E7EB] rounded-2xl shadow-sm p-8 space-y-6">

        <div class="text-center flex flex-col gap-1">
            <h1 class="text-2xl font-semibold text-[#111827]">Entre na conta</h1>
            <p class="text-sm text-gray-500">Acesse sua conta para continuar</p>
        </div>

        <div class="space-y-5" wire:keydown.enter.prevent="submit">
